...
data_col <- c('husage','husunion','husearns','huseduc','husblck', 'hushisp', 'kidge6','hushrs','age','black','educ','hispanic','union','exper','kidlt6','lwage')

summary(train)
summary(test)
dummies <- dummyVars(lwage~husage+husunion+husearns+huseduc+husblck+hushisp+hushrs+
...
print(exp(CIlwr_ridge))
print("Resultado  Superior ")
print(exp(CIupr_ridge))
